...
define(['./workbox-529b8e9d'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/.*\.googleapis\.com\/.*/i, new workbox.NetworkOnly(), 'GET');
  workbox.registerRoute(/^https:\/\/.*\.firebaseio\.com\/.*/i, new workbox.NetworkOnly(), 'GET');
